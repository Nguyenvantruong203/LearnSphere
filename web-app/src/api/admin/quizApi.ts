...
export const quizApi = {
  ...
  async getQuizzesByLesson(lessonId: number): Promise<Quiz[]> {
    return await httpAdmin(`/api/admin/lessons/${lessonId}/quizzes`, {
      method: 'GET',
    })
  },
  ...
  async getQuizzesByTopic(topicId: number): Promise<Quiz[]> {
    return await httpAdmin(`/api/admin/topics/${topicId}/quizzes`, {
      method: 'GET',
    })
  },
  ...
  async getQuiz(id: number): Promise<Quiz> {
    return await httpAdmin(`/api/admin/quizzes/${id}`, { method: 'GET' })
  },
  ...
  async updateQuiz(id: number, payload: Partial<QuizPayload>): Promise<Quiz> {
    return await httpAdmin(`/api/admin/quizzes/${id}`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
      body: payload,
    })
  ...
  async deleteQuiz(id: number): Promise<void> {
    await httpAdmin(`/api/admin/quizzes/${id}`, {
      method: 'DELETE',
    })
  },
}
