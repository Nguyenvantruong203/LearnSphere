...
export const lessonQuestionApi = {
  ...
  async getQuestions(
    ...
    return await httpAdmin(`/api/instructor/quizzes/${quizId}/lesson-questions`, {
      method: 'GET',
      params,
  ...
  async updateQuestion(
    ...
    return await httpAdmin(`/api/instructor/quizzes/${quizId}/lesson-questions/${questionId}`, {
      method: 'PUT',
      body: data,
      withCredentials: true,
    })
  ...
  async generateQuestions(quizId: number, num: number): Promise<GenerateQuestionsResponse> {
    return await httpAdmin(`/api/instructor/quizzes/${quizId}/lesson-questions/ai-generate`, {
      method: 'POST',
      body: { num },
      withCredentials: true,
    })
  ...
  async deleteQuestion(quizId: number, questionId: number): Promise<void> {
    await httpAdmin(`/api/instructor/quizzes/${quizId}/questions/${questionId}`, {
      method: 'DELETE',
      withCredentials: true,
    })
  },
