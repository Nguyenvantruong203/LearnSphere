...
export const topicQuestionApi = {
  ...
  async getQuestions(
    ...
    return await httpAdmin(`/api/instructor/quizzes/${quizId}/topic-questions`, {
      method: 'GET',
      params,
  ...
  async suggestQuestions(quizId: number, num: number) {
    return await httpAdmin(`/api/instructor/quizzes/${quizId}/topic-questions/ai-suggest`, {
      method: 'POST',
      body: { num },
      withCredentials: true,
    })
  ...
  async getPool(quizId: number) {
    return await httpAdmin(`/api/instructor/quizzes/${quizId}/topic-questions/pool`, {
      method: 'GET',
      withCredentials: true,
    })
  },
  ...
  async publishQuestions(quizId: number, questionIds: number[]) {
    return await httpAdmin(`/api/instructor/quizzes/${quizId}/topic-questions/publish`, {
      method: 'POST',
