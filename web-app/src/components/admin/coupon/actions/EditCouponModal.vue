...
const populateForm = (coupon: Coupon) => {
  Object.assign(form, {
    ...
    valid_from: coupon.valid_from ? dayjs(coupon.valid_from) : undefined,
    valid_to: coupon.valid_to ? dayjs(coupon.valid_to) : undefined,
...
watch(() => props.visible, (newVal) => {
  ...
  if (newVal && props.coupon) {
    populateForm(props.coupon)
  }
})
...
watch(() => props.coupon, (newCoupon) => {
  if (newCoupon && visible.value) {
    populateForm(newCoupon)
  }
})
</script>
