<template>
  <section class="py-24 bg-gray-50">
    <div class="max-w-7xl mx-auto px-6 lg:px-20">
      <!-- Header -->
      <div v-motion class="flex justify-between items-center mb-16" :initial="{ opacity: 0, y: 40 }"
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
        <article v-for="(post, index) in blogPosts" :key="post.id" v-motion
          :initial="{ opacity: 0, y: 50, scale: 0.95 }" :enter="{
            opacity: 1,
            y: 0,
            scale: 1,
      ...
      <!-- Pagination -->
      <div v-motion class="flex justify-center mt-16" :initial="{ opacity: 0, y: 30 }"
