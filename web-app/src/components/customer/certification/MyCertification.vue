  ...
  <section class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-12 px-4 md:px-6">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center mb-12">
        <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full mb-6 shadow-lg animate-bounce-slow">
      ...
      <div v-else-if="certificates.length === 0" class="text-center py-20">
        <div class="mb-8">
          <div class="w-32 h-32 bg-gradient-to-r from-gray-100 to-gray-200 rounded-full mx-auto flex items-center justify-center mb-6">
      ...
      <div v-else>
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            ...
            <p class="text-gray-600">{{ certificates.length }} certificate{{ certificates.length !== 1 ? 's' : '' }} found</p>
          </div>
        ...
        >
          <CertificateCard
            v-for="(item, index) in sortedCertificates"
            :key="item.id"
            :certificate="item"
            :viewMode="viewMode"
            :index="index"
            @view="openCertificate(item.id)"
          />
        </div>
      </div>
    </div>
