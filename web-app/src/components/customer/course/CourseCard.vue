    ...
    <div class="p-6 space-y-4">
      ...
      <div v-if="showPrice" class="flex items-center justify-between pt-2">
        <div class="space-y-1">
          <div class="flex items-center space-x-2">
            <span class="text-teal-600 text-2xl font-bold">{{ course.price }}</span>
      ...
      <div v-if="showProgress" class="space-y-2">
        <div class="flex justify-between text-sm">
          ...
          <span class="text-teal-600 font-semibold">68%</span>
        </div>
        <div class="w-full bg-gray-200 rounded-full h-2">
          <div class="bg-gradient-to-r from-teal-500 to-cyan-500 h-2 rounded-full" style="width: 68%"></div>
        </div>
        <button class="w-full mt-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white py-2 rounded-xl font-semibold hover:from-teal-600 hover:to-cyan-600 transition-all duration-300 transform hover:scale-105">
          Tiếp tục học
        </button>
      </div>
    </div>
