...
import { topicApi } from '@/api/instructor/topicApi'
import { lessonApi } from '@/api/instructor/lessonApi'

// ====== Modal components ======
import CreateCourseModal from '@/components/instructor/course/actions/CreateCourseModal.vue'
import EditCourseModal from '@/components/instructor/course/actions/EditCourseModal.vue'
import CreateTopicModal from '@/components/instructor/topic/actions/CreateTopicModal.vue'
import CreateLessonModal from '@/components/instructor/lesson/actions/CreateLessonModal.vue'
import EditTopicModal from '@/components/instructor/topic/actions/EditTopicModal.vue'
import EditLessonModal from '@/components/instructor/lesson/actions/EditLessonModal.vue'
